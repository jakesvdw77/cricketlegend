...
const MatchCardPreview: React.FC<TemplateProps> = ({
  ...
  const s = {
    ...
    vsRow: { display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: 2, marginBottom: 10 } as React.CSSProperties,
    teamName: { color: '#fff', fontSize: 18, fontWeight: 700, textAlign: 'center' as const, lineHeight: 1.25, wordBreak: 'break-word' as const } as React.CSSProperties,
    vs: { color: '#28b463', fontSize: 13, fontWeight: 700 },
    ...
    row: { display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 3, flexWrap: 'wrap' as const } as React.CSSProperties,
    icon: { color: '#28b463', fontSize: 10, fontWeight: 700, minWidth: 20, flexShrink: 0 },
    name: { color: '#cde4f0', fontSize: 13, fontWeight: 600, flex: 1, minWidth: 0 } as React.CSSProperties,
    stat: { color: '#7fb3d3', fontSize: 12, whiteSpace: 'nowrap' as const } as React.CSSProperties,
